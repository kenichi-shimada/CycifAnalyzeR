...
#' Expand a cell lineage definition table to include cell-state combinations
#'
#' Internally used only within \code{\link{CellTypeSkeleton}}, so not exported.
#'
#' @param ctype A data.frame defining cell lineage (Parent/Child hierarchy).
#' @param cstate A data.frame defining cell state, rownames matching \code{ctype$Child}.
#' @param ctype.full Logical, whether to include the full (state-expanded) lineage definition. Default TRUE.
#'
#' @return An expanded lineage definition data.frame.
#' @keywords internal
